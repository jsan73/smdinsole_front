        ...
        <div class="list-group userlist">
          <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
            ...
            <div class="d-flex gap-2 w-100 justify-content-between">
              <div>
                <h4 class="mb-0">{{shoes.nickName}} <small class="opacity-75">A001</small></h4>
                <p class="mb-0 mt-1">{{shoes.rangeName}} - {{shoes.radius}}</p>
              </div>
            </div>
            <div class="battery"><img src='/static/images/battery/1.svg' alt="배터리2칸" width="32" height="32"></div>
          </a>
        </div>
      </div>
